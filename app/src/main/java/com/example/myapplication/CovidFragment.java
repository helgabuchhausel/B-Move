...
public class CovidFragment extends Fragment {
     ...
     * @return A new instance of fragment Covid_News_Fragment.
     */
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        WebView myCovidWebView = (WebView) getView().findViewById(R.id.CovidWebView);
        myCovidWebView.loadUrl("https://www.info-coronavirus.be/en/news/");
    }
}